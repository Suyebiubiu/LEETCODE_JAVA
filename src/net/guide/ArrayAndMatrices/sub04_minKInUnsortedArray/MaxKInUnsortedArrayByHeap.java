 ...
 * 题目：给定一个无序的整型数组 arr，找到其中最大的 k 个数
 * 直接排序O(NlogN)。
 * 本题要求实现时间复杂度为 O(Nlogk)和 O(N)的方法。
 */
public class MaxKInUnsortedArrayByHeap {
    public static void main(String[] args) {
        int[] arr = {100, 18, 6, 12, 9, 3, 100};
        getMaxKNumsByHeap(arr, 3);
    }
     ...
     * 维护一个小顶堆
     */
    public static int[] getMaxKNumsByHeap(int[] arr, int k) {
